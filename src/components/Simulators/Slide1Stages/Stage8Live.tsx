...
export const Stage8Live: React.FC = () => {
  return (
    <div className="flex flex-col gap-4 font-mono select-none">
      ...
      {/* Connected 4-Node Full-Stack Circuit Strip with Bold Typography */}
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-2.5 text-xs">
        ...
        <div className="p-4 bg-[#090a10] border-2 border-[#55FFFF] text-center shadow-pixel">
          ...
          <span className="text-xs text-[#55FFFF] font-extrabold block">1. VISITOR CLIENT</span>
          <p className="text-xs text-zinc-200 mt-1 font-medium">Renders React UI & captures clicks</p>
        </div>
        ...
        <div className="p-4 bg-[#090a10] border-2 border-[#FFAA00] text-center shadow-pixel">
          ...
          <span className="text-xs text-[#FFAA00] font-extrabold block">2. DOMAIN & CDN</span>
          <p className="text-xs text-zinc-200 mt-1 font-medium">Resolves DNS & serves cached bundle</p>
        </div>
        ...
        <div className="p-4 bg-[#090a10] border-2 border-[#0088FF] text-center shadow-pixel">
          ...
          <span className="text-xs text-[#0088FF] font-extrabold block">3. BACKEND API</span>
          <p className="text-xs text-zinc-200 mt-1 font-medium">Validates tokens & executes rules</p>
        </div>
        ...
        <div className="p-4 bg-[#090a10] border-2 border-[#55FF55] text-center shadow-pixel">
          ...
          <span className="text-xs text-[#55FF55] font-extrabold block">4. DATABASE VAULT</span>
          <p className="text-xs text-zinc-200 mt-1 font-medium">Saves records permanently to disk</p>
        </div>
      </div>
      ...
      <div className="p-4 bg-[#121420] border-2 border-[#55FFFF] shadow-pixel flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <span className="text-xs text-[#55FFFF] font-extrabold uppercase block mb-1">
        ...
        <span className="text-xs text-[#55FF55] font-extrabold px-3 py-1.5 bg-[#090a10] border border-[#55FF55] shrink-0 w-fit">
          ✓ READY TO BUILD
        </span>
      </div>
    </div>
