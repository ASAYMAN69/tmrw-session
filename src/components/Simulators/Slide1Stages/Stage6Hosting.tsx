    ...
    <div className="flex flex-col gap-4 font-mono select-none">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-4 bg-[#090a10] border-2 border-[#FF5555] shadow-pixel flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-extrabold text-[#FF5555] uppercase">
            ...
            <div className="p-3 bg-[#121420] border border-[#2e334a] text-xs text-[#FF5555] space-y-1.5 font-medium">
        ...
        <div className="p-4 bg-[#090a10] border-2 border-[#55FFFF] shadow-pixel flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-extrabold text-[#55FFFF] uppercase">
            ...
            <div className="p-3 bg-[#121420] border border-[#2e334a] text-xs text-[#55FF55] space-y-1.5 font-medium">
      ...
      <div className="p-3.5 bg-[#121420] border border-[#2e334a] flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs text-zinc-200">
        <div className="flex items-center gap-2">
          <span className="text-[#55FFFF] font-extrabold">AUTOMATED DEPLOY:</span>
          <span><code>git push origin master</code> ➔ Cloud Build (30s) ➔ Live Worldwide!</span>
        </div>
        <span className="text-[#55FF55] font-extrabold shrink-0">Tools: Vercel, Netlify, Render</span>
      </div>
    </div>
  );
};
